    ...
    <div className='h-screen flex flex-row gap-10 items-center justify-center p-4 sm:p-6 md:p-8 bg-no-repeat bg-cover ' style={{ backgroundImage: "url('/Assets/8.jpg')" }}>
      ...
      <div className="absolute inset-0 z-0 opacity-50" data-theme={theme}></div>
       ...
       <div className="relative z-10 flex flex-col lg:flex-row w-full max-w-5xl mx-auto 
          ...
          scale-[0.80] origin-top transform 
          bg-contain 
         "style={{ width: "118%", transformOrigin: "center" }}>

        {/* logo image */}
        {/* <div className="absolute bottom-0  w-full h-[600px] bg-no-repeat bg-right-bottom    bg-contain pointer-events-none opacity-90  hidden lg:flex z-0 scale-[0.85] origin-top transform "
        style={{ backgroundImage: "url('/Assets/5.png')" , transformOrigin: "center"}}
        ></div> */}
        ...
        <ThemeSelector/>
         ...
         <div className=" relative h-full sm:p-8 shadow-lg rounded-2xl bg-base-100 overflow-hidden" >
            <div className='mb-4 flex items-center justify-start gap-2'>
            <LayoutTemplate className='size-9 text-primary'/>
            <span className='text-[40px] font-bold font-mono bg-clip-text text-transparent     bg-gradient-to-r from-primary to-secondary tracking-wider'>
              WEBGEN
            </span>
          </div>  
